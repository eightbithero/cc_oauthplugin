...
class sfOauthDeveloperActions extends sfActions
{
  ...
  {
  $this->forward404Unless($this->application = sfOauthServerConsumerQuery::create()->find(array($request->getParameter('id'))), sprintf('Object sf_oauth_server_consumer does not exist (%s).', $request->getParameter('id')));
  ...
  {
    $this->forward404Unless($sf_oauth_server_consumer = sfOauthServerConsumerQuery::create()->find(array($request->getParameter('id'))), sprintf('Object sf_oauth_server_consumer does not exist (%s).', $request->getParameter('id')));
