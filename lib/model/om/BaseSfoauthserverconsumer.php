...
abstract class BaseSfoauthserverconsumer extends BaseObject implements Persistent
{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		{
			$this->setConsumerKey($arr[$keys[0]]);
		}
		if(array_key_exists($keys[1], $arr))
		{
			$this->setConsumerSecret($arr[$keys[1]]);
		}
		...
		{
			$this->setProtocole($arr[$keys[4]]);
		}
		if(array_key_exists($keys[5], $arr))
		{
			$this->setBaseDomain($arr[$keys[5]]);
		}
		if(array_key_exists($keys[6], $arr))
		{
			$this->setCallback($arr[$keys[6]]);
		}
		if(array_key_exists($keys[7], $arr))
		{
			$this->setScope($arr[$keys[7]]);
		}
		if(array_key_exists($keys[8], $arr))
		{
			$this->setNumberQuery($arr[$keys[8]]);
		}
	...
	public function buildCriteria()
	{
		...
		if($this->isColumnModified(SfoauthserverconsumerPeer::CONSUMER_KEY))
		{
			$criteria->add(SfoauthserverconsumerPeer::CONSUMER_KEY, $this->consumer_key);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::CONSUMER_SECRET))
		{
			$criteria->add(SfoauthserverconsumerPeer::CONSUMER_SECRET, $this->consumer_secret);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::NAME))
		{
			$criteria->add(SfoauthserverconsumerPeer::NAME, $this->name);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::DESCRIPTION))
		{
			$criteria->add(SfoauthserverconsumerPeer::DESCRIPTION, $this->description);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::PROTOCOLE))
		{
			$criteria->add(SfoauthserverconsumerPeer::PROTOCOLE, $this->protocole);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::BASE_DOMAIN))
		{
			$criteria->add(SfoauthserverconsumerPeer::BASE_DOMAIN, $this->base_domain);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::CALLBACK))
		{
			$criteria->add(SfoauthserverconsumerPeer::CALLBACK, $this->callback);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::SCOPE))
		{
			$criteria->add(SfoauthserverconsumerPeer::SCOPE, $this->scope);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::NUMBER_QUERY))
		{
			$criteria->add(SfoauthserverconsumerPeer::NUMBER_QUERY, $this->number_query);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::ID))
		{
		...
		if($this->isColumnModified(SfoauthserverconsumerPeer::CREATED_AT))
		{
			$criteria->add(SfoauthserverconsumerPeer::CREATED_AT, $this->created_at);
		}
		if($this->isColumnModified(SfoauthserverconsumerPeer::UPDATED_AT))
		{
			$criteria->add(SfoauthserverconsumerPeer::UPDATED_AT, $this->updated_at);
		}
	...
	public function addSfoauthserverdeveloper(Sfoauthserverdeveloper $l)
	{
		...
		if(!$this->collSfoauthserverdevelopers->contains($l))
	...
	public function addSfoauthserverrequesttoken(Sfoauthserverrequesttoken $l)
	{
		...
		if(!$this->collSfoauthserverrequesttokens->contains($l))
		{ // only add it if the **same** object is not already associated
	...
	public function addSfoauthserveraccesstoken(Sfoauthserveraccesstoken $l)
	{
		...
		if(!$this->collSfoauthserveraccesstokens->contains($l))
		{ // only add it if the **same** object is not already associated
	...
	public function addSfoauthserveruserscope(Sfoauthserveruserscope $l)
	{
		...
		if(!$this->collSfoauthserveruserscopes->contains($l))
		{ // only add it if the **same** object is not already associated
